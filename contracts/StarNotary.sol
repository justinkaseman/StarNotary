...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            msg.sender == tokenOwner1 || msg.sender == tokenOwner2,
            "You must own one of the stars to exchange them"
        );
        _transferFrom(tokenOwner1, tokenOwner2, _tokenId1);
        _transferFrom(tokenOwner2, tokenOwner1, _tokenId2);
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            ...
            "You must own a Star to transfer ownership of it"
        );
